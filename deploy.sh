...
mkdir -p deploy/premedkb

# Copy built files
cp -r fudanpgx/dist/* deploy/fudanpgx/
cp -r chihope/dist/* deploy/chihope/

# Create premedkb redirect to portal.fudan-pgx.org
cat > deploy/premedkb/index.html << 'EOF'
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>PreMedKB - Redirecting</title>
    <meta http-equiv="refresh" content="0; url=https://portal.fudan-pgx.org">
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <h1 class="title">PreMedKB</h1>
        <p class="subtitle">Redirecting to Portal</p>
        <p class="redirect-text">
            Redirecting to <a href="https://portal.fudan-pgx.org" class="link">portal.fudan-pgx.org</a>...
        </p>
    </div>
</body>
</html>
